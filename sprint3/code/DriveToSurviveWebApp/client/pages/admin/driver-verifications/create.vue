      ...
      <div class="mx-auto max-w-6xl">
        ...
        <div class="flex flex-col gap-3 mb-6 sm:flex-row sm:items-center sm:justify-between">
          <div class="flex items-center gap-3">
            <h1 class="text-2xl font-semibold text-primary">สร้างคำขอยืนยันตัวตน (แอดมิน)</h1>
            <span class="text-sm text-slate-400">กรอกข้อมูลและอัปโหลดภาพ เพื่อยืนยันตัวตนให้ผู้ใช้ที่เลือก</span>
          </div>
        </div>

        <!-- Card -->
        <div class="flex bg-white rounded-lg shadow-sm overflow-hidden w-full border border-slate-200">
          <main class="flex-1 p-8">
            <!-- STEP 0 เลือกผู้ใช้ -->
            <div class="mb-8">
              <div class="flex items-center mb-4">
                <div class="step-indicator mr-4">0</div>
                <h2 class="text-xl font-semibold text-primary">เลือกผู้ใช้ที่จะยืนยัน</h2>
              </div>
              ...
              <div class="relative">
                ...
                <input
                  ...
                  class="w-full border border-slate-200 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-cta"
                />
                <!-- results -->
                <div
                  v-if="showResultList"
                ...
                >
                  <button
                    ...
                    type="button"
                    @click="selectUser(u)"
                    class="w-full text-left px-3 py-2 hover:bg-cta-light"
                  >
                    <div class="text-sm font-medium text-primary">
                      {{ u.firstName }} {{ u.lastName }}
                      <span v-if="u.username" class="text-xs text-slate-400">(@{{ u.username }})</span>
                    </div>
                    <div class="text-xs text-slate-400">{{ u.email }}</div>
                  </button>
                  <div v-if="!isSearching && userResults.length === 0" class="px-3 py-2 text-sm text-slate-400">
            ...
            <div class="text-center mb-8">
              ...
              <h1 class="text-3xl font-bold text-primary mb-2">การยืนยันตัวตนสำหรับผู้ขับขี่</h1>
            ...
            <div class="bg-white rounded-xl">
              <form @submit.prevent="handleSubmit" novalidate class="space-y-8">
                ...
                <div class="relative">
                  ...
                  <h4 class="text-sm font-medium text-primary mb-2">ตัวอย่างที่ถูกต้อง:</h4>
                  <div class="grid md:grid-cols-2 gap-6 mb-6">
                        ...
                        <div class="relative z-10 h-full flex flex-col justify-between">
                          ...
                          <div class="flex items-center space-x-3">
                            <div class="w-12 h-12 bg-blue-300 rounded-md flex items-center justify-center">
                              <svg class="w-6 h-6 text-cta-hover" fill="currentColor" viewBox="0 0 20 20">
                                <path
                                  fill-rule="evenodd"
                            ...
                            <div>
                              <div class="text-xs text-cta-hover font-semibold">นาย สมชาย ใจดี</div>
                    ...
                    <div
                      ...
                      class="upload-zone h-40 border-2 border-dashed border-slate-200 rounded-lg p-8 bg-slate-50 hover:bg-slate-100 hover:border-blue-400 relative flex items-center justify-center"
                    >
                      <div v-if="!previews.licensePhoto" class="text-center">
                        ...
                        <p class="text-lg text-slate-500 mb-2">คลิกเพื่ออัปโหลด</p>
                ...
                <div class="relative">
                  ...
                  <div class="grid md:grid-cols-2 gap-6 mb-6">
                    <div class="space-y-4">
                      ...
                      <p class="text-xs text-slate-500 text-center">ถือบัตรชิดข้างใบหน้า ให้เห็นทั้งสองอย่างชัดเจน</p>
                    </div>
                ...
                <div class="relative">
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                    <div>
                      <label for="firstNameOnLicense" class="block text-sm font-medium text-primary mb-2">
                    ...
                    <div>
                      <label for="lastNameOnLicense" class="block text-sm font-medium text-primary mb-2">
                    ...
                    <div>
                      <label for="licenseNumber" class="block text-sm font-medium text-primary mb-2">
                    ...
                    <div>
                      <label for="typeOnLicense" class="block text-sm font-medium text-primary mb-2">
                    ...
                    <div>
                      <label for="licenseIssueDate" class="block text-sm font-medium text-primary mb-2">
                    ...
                    <div>
                      <label for="licenseExpiryDate" class="block text-sm font-medium text-primary mb-2">
                ...
                <div class="pt-6 flex justify-end gap-4">
                  <button
                    ...
                    class="px-6 py-3 border border-slate-200 text-primary rounded-md hover:bg-slate-100 focus:outline-none focus:ring-2 focus:ring-gray-400 disabled:opacity-50"
                  >
                    ยกเลิก
                  </button>
                  <button
                    ...
                    class="px-6 py-3 bg-cta text-white rounded-md font-medium hover:bg-cta-hover focus:outline-none focus:ring-2 focus:ring-cta disabled:bg-blue-400 disabled:cursor-not-allowed flex items-center"
                  >
                    <svg
                      v-if="isSubmitting"
