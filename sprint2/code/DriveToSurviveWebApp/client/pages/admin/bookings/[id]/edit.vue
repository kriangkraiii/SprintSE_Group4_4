            ...
            <div class="mx-auto max-w-7xl">
                ...
                <div class="flex flex-col gap-3 mb-6 sm:flex-row sm:items-center sm:justify-between">
                    <div class="flex items-center gap-3">
                        <h1 class="text-2xl font-semibold text-primary">แก้ไขการจอง (แอดมิน)</h1>
                        <span class="text-sm text-slate-400">ปรับเส้นทาง ผู้โดยสาร จำนวนที่นั่ง และจุดรับ-ส่ง</span>
                    </div>
                </div>
                ...
                <div class="flex w-full overflow-hidden bg-white border border-slate-200 rounded-lg shadow-sm">
                    <main class="flex-1 p-8 space-y-8">
                        ...
                        <section>
                            <h3 class="mb-3 text-sm font-semibold text-primary">เส้นทางและผู้โดยสาร</h3>
                                ...
                                <div class="relative">
                                    ...
                                    <div v-if="showRouteList"
                                        ...
                                        <button v-for="r in routeResults" :key="r.id" type="button"
                                            @click="selectRoute(r)" class="w-full px-3 py-2 text-left hover:bg-cta-light">
                                    ...
                                    <p v-else class="mt-2 text-xs text-slate-500 truncate">เลือกแล้ว: {{
                                ...
                                <div class="relative">
                                    ...
                                    <div v-if="showUserList"
                                        ...
                                        <button v-for="u in userResults" :key="u.id" type="button"
                                            @click="selectUser(u)" class="w-full px-3 py-2 text-left hover:bg-cta-light">
                                            <div class="text-sm font-medium text-primary">
                        ...
                        <section>
                            <h3 class="mb-3 text-sm font-semibold text-primary">รายละเอียดการจอง</h3>
                            <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                                ...
                                <div>
                                    <label class="block mb-1 text-xs font-medium text-slate-500">ราคาต่อที่นั่ง
                                        (อ้างอิงจากเส้นทาง)</label>
                                    <input :value="selectedRoute ? selectedRoute.pricePerSeat : ''" disabled
                                        class="w-full px-3 py-2 border border-slate-200 rounded-md disabled:bg-slate-100" />
                                </div>
                                <div>
                                    <label class="block mb-1 text-xs font-medium text-slate-500">เวลาออกเดินทาง</label>
            ...
            <div v-if="bookingPickingTarget" class="fixed inset-0 z-50 flex items-center justify-center bg-black/60"
                ...
                <div class="bg-white rounded-lg w-[95%] max-w-3xl overflow-hidden">
                    <div class="flex items-center justify-between p-4 border-b border-slate-200">
                        <h3 class="text-lg font-semibold text-primary">เลือก{{ bookingPickingTarget === 'pickup' ?
                            'จุดขึ้นรถ' : 'จุดลงรถ' }}</h3>
                        <button @click="stopBookingPicker" class="text-slate-300 hover:text-slate-500"><i
