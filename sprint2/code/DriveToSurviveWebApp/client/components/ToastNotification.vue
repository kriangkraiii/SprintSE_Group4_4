<template>
    <transition enter-active-class="transform ease-out duration-300 transition"
        ...
        <div v-if="show"
            class="toast-container max-w-sm w-full bg-white shadow-sm rounded-lg pointer-events-auto ring-1 ring-black ring-opacity-5 overflow-hidden">
            <div class="p-4">
                <div class="flex items-start">
                    ...
                    <div class="ml-4 flex-shrink-0 flex">
                        <button @click="close"
                            class="bg-white rounded-md inline-flex text-slate-300 hover:text-slate-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cta">
