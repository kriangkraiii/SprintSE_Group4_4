            ...
            <div class="mx-auto max-w-8xl">
                <div class="flex flex-col gap-3 mb-6 sm:flex-row sm:items-center sm:justify-between">
                    <div class="flex items-center gap-3">
                        <h1 class="text-2xl font-semibold text-primary">สร้างยานพาหนะใหม่</h1>
                        <span class="text-sm text-slate-400">กรอกข้อมูลให้ครบถ้วน แล้วกด “บันทึก”</span>
                    </div>
                </div>
                ...
                <div class="bg-white border border-slate-200 rounded-lg shadow-sm">
                    ...
                    <div class="grid grid-cols-1 gap-6 p-4 sm:p-6">
                        <div class="w-full max-w-[80rem] mx-auto space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <div
                                                ...
                                                class="absolute z-10 w-full mt-1 overflow-auto bg-white border border-slate-200 rounded-md shadow-sm max-h-60"
                                            >
                                                <ul>
                                                    <li
                                                        ...
                                                        class="px-3 py-2 cursor-pointer hover:bg-cta-light"
                                                    >
                            ...
                            <div>
                                <h3 class="mb-3 text-sm font-semibold text-primary">สิ่งอำนวยความสะดวก (คั่นด้วย ,)</h3>
                                <input
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-1 gap-6 sm:grid-cols-3">
                                    <div>
                                        ...
                                        <div
                                            class="p-4 text-center border-2 border-slate-200 border-dashed rounded-md cursor-pointer hover:border-cta"
                            ...
                            <div>
                                ...
                                <div class="flex items-center">
                                    <input
                                        ...
                                        type="checkbox"
                                        class="w-4 h-4 text-cta border-slate-200 rounded focus:ring-cta"
                                    />
                                    <label for="isDefault" class="block ml-2 text-sm text-primary">
