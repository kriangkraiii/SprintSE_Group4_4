            ...
            <div class="mx-auto max-w-8xl">
                ...
                <div class="mb-4 bg-white border border-slate-200 rounded-lg shadow-sm">
                    <div class="grid grid-cols-1 gap-3 px-4 py-4 sm:px-6 lg:grid-cols-[repeat(24,minmax(0,1fr))]">
                        ...
                        <!-- End (3/24) -->
                        <div class="lg:col-span-3">
                            <label class="block mb-1 text-xs font-medium text-slate-500">ปลายทาง</label>
                        ...
                        <div class="lg:col-span-4">
                            <label class="block mb-1 text-xs font-medium text-slate-500">ออกเดินทางตั้งแต่
                                (YYYY-MM-DD)</label>
                    ...
                    <div v-else class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-slate-100">
                            <thead class="bg-slate-50">
                                <tr>
                                    <th class="px-4 py-3 text-xs font-medium text-left text-slate-400 uppercase">ผู้ใช้
                                    </th>
                                    <th class="px-4 py-3 text-xs font-medium text-left text-slate-400 uppercase">อีเมล
                                    </th>
                                    <th class="px-4 py-3 text-xs font-medium text-left text-slate-400 uppercase">
                                        ชื่อผู้ใช้</th>
                                    <th class="px-4 py-3 text-xs font-medium text-left text-slate-400 uppercase">บทบาท
                                    </th>
                                    <th class="px-4 py-3 text-xs font-medium text-left text-slate-400 uppercase">
                                        ยืนยันตัวตน</th>
                            ...
                            <tbody class="bg-white divide-y divide-slate-100">
                                <tr v-for="u in users" :key="u.id" class="transition-opacity hover:bg-slate-50"
                                    ...
                                    <td class="px-4 py-3 text-primary">{{ u.email }}</td>
                                    <td class="px-4 py-3 text-primary">{{ u.username }}</td>
                                    <td class="px-4 py-3">
                                        <span
                                    ...
                                    <td class="px-4 py-3">
                                        <span
                                            class="inline-flex items-center px-2 py-1 text-xs font-medium rounded-full"
                                            :class="u.isVerified ? 'bg-green-100 text-green-700' : 'bg-slate-100 text-slate-500'">
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex items-center">
                                            ...
                                            <span class="ml-2 text-sm "
                                                :class="u.isActive ? 'text-green-700' : 'text-slate-400'">
                                    ...
                                    <td class="px-4 py-3 text-primary">
                                        ...
                                        <div class="text-xs text-slate-400">อัปเดต {{ formatDate(u.updatedAt) }}</div>
                                    </td>
                                ...
                                <tr v-if="!users.length">
                                    <td colspan="8" class="px-4 py-10 text-center text-slate-400">ไม่มีข้อมูลผู้ใช้</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
