            ...
            <div class="mx-auto max-w-8xl">
                ...
                <div class="flex flex-col gap-3 mb-6 sm:flex-row sm:items-center sm:justify-between">
                    <div class="flex items-center gap-3">
                        <h1 class="text-2xl font-semibold text-primary">รายละเอียดการจอง</h1>
                        <span class="text-sm text-slate-400">ดูข้อมูลทั้งหมดของ Booking</span>
                    </div>
                ...
                <div class="bg-white border border-slate-200 rounded-lg shadow-sm">
                    <div class="px-4 py-4 border-b border-slate-100 sm:px-6">
                        <h2 class="font-medium text-primary">ข้อมูลการจอง</h2>
                    </div>
                    ...
                    <div v-else class="grid grid-cols-1 gap-6 p-4 sm:p-6 text-[15px]">
                        <div class="w-full max-w-[80rem] mx-auto space-y-6">
                            ...
                            <!-- สรุปการจอง -->
                            <section>
                                <h3 class="mb-3 text-sm font-semibold text-primary">สรุปการจอง</h3>
                                <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                                    <div>
                                        <label class="block mb-1 text-xs font-medium text-slate-500">Booking ID</label>
                                        <div
                                    ...
                                    <div>
                                        ...
                                        <div class="w-full px-3 py-2.5 border border-slate-200 rounded-md bg-slate-50">
                                            <span
                            ...
                            <!-- จุดรับ/จุดส่ง -->
                            <section>
                                <h3 class="mb-3 text-sm font-semibold text-primary">จุดรับ / จุดส่ง</h3>
                                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                    <div>
                                        <label
                                            class="block mb-1 text-xs font-medium text-slate-500">จุดรับผู้โดยสาร</label>
                                        <div
                                            class="w-full px-3 py-2.5 border border-slate-200 rounded-md bg-slate-50 text-primary">
                                    ...
                                    <div>
                                        <label
                                            class="block mb-1 text-xs font-medium text-slate-500">จุดส่งผู้โดยสาร</label>
                                        <div
                                            class="w-full px-3 py-2.5 border border-slate-200 rounded-md bg-slate-50 text-primary">
                            ...
                            <section>
                                <h3 class="mb-3 text-sm font-semibold text-primary">รายละเอียดเส้นทาง</h3>
                                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                    <div>
                                        <label class="block mb-1 text-xs font-medium text-slate-500">จุดเริ่มต้น</label>
                                        <div
                                            class="w-full px-3 py-2.5 border border-slate-200 rounded-md bg-slate-50 text-primary">
                                            {{ routeData?.originName || '-' }}
                                            <div v-if="routeData?.originAddress" class="mt-1 text-xs text-slate-400">
                                                {{ routeData.originAddress }}
                                            </div>
                                        </div>
                                    </div>
                                    <div>
                                        <label class="block mb-1 text-xs font-medium text-slate-500">จุดปลายทาง</label>
                                        <div
                                            class="w-full px-3 py-2.5 border border-slate-200 rounded-md bg-slate-50 text-primary">
                                ...
                                <div class="grid grid-cols-1 gap-4 mt-4 sm:grid-cols-3">
                                    <div>
                                        <label
                                            class="block mb-1 text-xs font-medium text-slate-500">วัน-เวลาออกเดินทาง</label>
                                        <div class="w-full px-3 py-2.5 border border-slate-200 rounded-md bg-slate-50">
                                    ...
                                    <div>
                                        <label class="block mb-1 text-xs font-medium text-slate-500">ราคา/ที่นั่ง</label>
                                        <div
                                            class="w-full px-3 py-2.5 border border-slate-200 rounded-md bg-slate-50 text-primary">
                                    ...
                                    <div>
                                        <label
                                            class="block mb-1 text-xs font-medium text-slate-500">ที่นั่งคงเหลือ</label>
                                        <div
                                            class="w-full px-3 py-2.5 border border-slate-200 rounded-md bg-slate-50 text-primary">
                                ...
                                <div class="grid grid-cols-1 gap-4 mt-4 sm:grid-cols-2">
                                    <div>
                                        <label
                                            class="block mb-1 text-xs font-medium text-slate-500">ระยะเวลาโดยประมาณ</label>
                                        <div
                                            class="w-full px-3 py-2.5 border border-slate-200 rounded-md bg-slate-50 text-primary">
                                    ...
                                    <div>
                                        <label
                                            class="block mb-1 text-xs font-medium text-slate-500">ระยะทางโดยประมาณ</label>
                                        <div
                                            class="w-full px-3 py-2.5 border border-slate-200 rounded-md bg-slate-50 text-primary">
                            ...
                            <!-- ผู้ขับขี่ -->
                            <section>
                                <h3 class="mb-3 text-sm font-semibold text-primary">ผู้ขับขี่</h3>
                                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                    <div>
                                        <label class="block mb-1 text-xs font-medium text-slate-500">ชื่อผู้ขับ</label>
                                        <div
                                            class="w-full px-3 py-2.5 border border-slate-200 rounded-md bg-slate-50 text-primary">
                                    ...
                                    <div>
                                        <label
                                            class="block mb-1 text-xs font-medium text-slate-500">การยืนยันตัวตน</label>
                                        <div
                                            class="w-full px-3 py-2.5 border border-slate-200 rounded-md bg-slate-50 text-primary">
                            ...
                            <!-- รายละเอียดรถ -->
                            <section>
                                <h3 class="mb-3 text-sm font-semibold text-primary">รายละเอียดรถ</h3>
                                <div class="w-full px-3 py-2.5 border border-slate-200 rounded-md bg-slate-50">
                                    ...
                                    <template v-else>
                                        <div class="text-slate-400">— ไม่มีข้อมูลรถ —</div>
                                    </template>
                                </div>
                            </section>
                            ...
                            <!-- ผู้โดยสาร -->
                            <section>
                                <h3 class="mb-3 text-sm font-semibold text-primary">ผู้โดยสาร</h3>
                                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                    <div>
                                        <label class="block mb-1 text-xs font-medium text-slate-500">ชื่อ-สกุล</label>
                                        <div
                                            class="w-full px-3 py-2.5 border border-slate-200 rounded-md bg-slate-50 text-primary">
                                            {{ passengerName || '-' }}
                                        </div>
...
function statusBadge(s) {
    ...
    if (s === 'REJECTED') return 'bg-slate-200 text-primary'
