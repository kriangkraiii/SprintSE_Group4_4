            ...
            <div class="mx-auto max-w-8xl">
                ...
                <div class="flex flex-col gap-3 mb-6 sm:flex-row sm:items-center sm:justify-between">
                    <div class="flex items-center gap-3">
                        <h1 class="text-2xl font-semibold text-primary">รายละเอียดเส้นทาง</h1>
                        <span class="text-sm text-slate-400">ดูข้อมูลทั้งหมดของ Route</span>
                    </div>
                ...
                <div class="bg-white border border-slate-200 rounded-lg shadow-sm">
                    <div class="px-4 py-4 border-b border-slate-100 sm:px-6">
                        <h2 class="font-medium text-primary">ข้อมูลเส้นทาง</h2>
                    </div>
                        ...
                        <div class="w-full max-w-[80rem] mx-auto space-y-6">
                            ...
                            <section>
                                ...
                                <div class="w-full px-3 py-2.5 border border-slate-200 rounded-md bg-slate-50">
                                    ...
                                    <template v-else>
                                        <div class="text-slate-400">— ไม่มีจุดแวะ —</div>
                                    </template>
                                </div>
                            </section>
                            ...
                            <section>
                                ...
                                <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                                    <div>
                                        ...
                                        <div class="w-full px-3 py-2.5 border border-slate-200 rounded-md bg-slate-50">
                                            <div class="text-primary">{{ routeData?.date || '-' }} {{
                            ...
                            <!-- รูปภาพรถ -->
                            <section>
                                <h3 class="mb-3 text-sm font-semibold text-primary">รูปภาพรถยนต์</h3>
                                    ...
                                    <template v-if="routeData?.photos?.length">
                                        <div v-for="(photo, idx) in routeData.photos.slice(0, 3)" :key="idx">
                                            <img :src="photo" alt="Vehicle"
                                                class="object-cover w-full transition-opacity border border-slate-200 rounded-lg shadow-sm aspect-video hover:opacity-90">
                                        </div>
                                    </template>
                                    <div v-else
                                        class="col-span-3 p-4 text-center text-slate-400 border border-slate-200 rounded-md bg-slate-50">
