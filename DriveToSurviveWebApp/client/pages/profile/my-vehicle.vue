                            ...
                            <div v-else class="space-y-3">
                                <div v-for="vehicle in vehicles" :key="vehicle.id"
                                    ...
                                    <div class="flex flex-col sm:flex-row gap-4">
                                        <img :src="vehicle.photos?.[0] || 'https://placehold.co/120x90/e2e8f0/94a3b8?text=No+Photo'" alt="Vehicle" class="w-24 h-20 rounded-lg object-cover bg-gray-100 shrink-0" />
                                    ...
                                    <div class="flex flex-wrap items-center justify-end gap-2 mt-3 pt-3 border-t"
                                        :class="vehicle.isDefault ? 'border-blue-200' : 'border-gray-100'">
