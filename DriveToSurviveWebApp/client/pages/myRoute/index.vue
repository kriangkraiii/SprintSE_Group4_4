<template>
    <div>
        <div class="px-4 py-8 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="mb-8">
                <h2 class="text-2xl font-bold text-primary">คำขอจองเส้นทางของฉัน</h2>
                <p class="mt-2 text-slate-500">ดูและจัดการคำขอจองจากผู้โดยสารในเส้นทางที่คุณสร้าง</p>
            </div>
            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
                <div class="lg:col-span-2">
                    <div class="bg-white border border-slate-200 rounded-lg shadow-sm">
                        ...
                        <!-- ===== แท็บ: เส้นทางของฉัน ===== -->
                        <div v-else-if="activeTab === 'myRoutes'" class="divide-y divide-slate-100">
                                ...
                                <div v-if="selectedTripId === route.id"
                                    ...
                                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                                        <div>
                                            ...
                                            <ul class="space-y-1 text-sm text-slate-500">
                                                <li>
                                                    • จุดเริ่มต้น:
                                                    <span class="font-medium text-primary">{{ route.origin }}</span>
                                                ...
                                                <li class="mt-1">
                                                    • จุดปลายทาง:
                                                    <span class="font-medium text-primary">{{ route.destination
                                                    }}</span>
                                    ...
                                    <div class="mt-4 space-y-4">
                                        ...
                                        <div v-if="route.passengers && route.passengers.length">
                                            <h5 class="mb-2 font-medium text-primary">ผู้โดยสาร ({{
                                                    ...
                                                    <div class="flex-1">
                                                        ...
                                                        <div class="text-sm text-slate-500">
                                                            ...
                                                            <a v-if="p.email" :href="`mailto:${p.email}`"
                                                                class="text-cta hover:underline" @click.stop>
                                                                {{ p.email }}
                                                            </a>
                                                        </div>
                                                    </div>
                        ...
                        <div v-else class="divide-y divide-slate-100">
                            ...
                            <div v-for="trip in filteredTrips" :key="trip.id"
                                ...
                                <div class="flex items-center mb-4 space-x-4">
                                    ...
                                    <div class="flex-1">
                                        <div class="flex items-center">
                                            <h5 class="font-medium text-primary">{{ trip.passenger.name }}</h5>
                                        ...
                                        <div class="flex">
                                            <p v-if="trip.passenger.email" class="text-xs text-slate-400 mt-0.5">
                                                อีเมล:
                                            ...
                                            <button v-if="trip.passenger.email"
                                                class="inline-flex items-center ml-1 text-slate-400 rounded hover:text-primary hover:bg-slate-100 focus:outline-none focus:ring-2 focus:ring-cta"
...
// --- Lifecycle ---
useHead({
    title: 'คำขอจองเส้นทางของฉัน - Drive To Survive',
