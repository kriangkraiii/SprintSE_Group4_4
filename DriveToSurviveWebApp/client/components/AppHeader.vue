            ...
            <div class="flex items-center justify-between h-16 relative px-4">
                ...
                <nav class="absolute left-1/2 transform -translate-x-1/2 items-center hidden gap-1 md:flex">
                    ...
                    <NuxtLink v-if="token" to="/reviews"
                        class="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium transition-all duration-200 rounded-lg cursor-pointer hover:bg-white/10"
                        :class="$route.path.startsWith('/reviews') ? 'text-cta bg-white/10' : 'text-black hover:text-[#236993]'">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                ...
                <nav class="items-center hidden gap-1 md:flex">
                    ...
                    <div v-if="token && (!user || user.role !== 'ADMIN')" class="relative ml-1 dropdown-trigger">
                        <button class="flex items-center gap-2 px-2 py-1.5 rounded-lg cursor-pointer hover:bg-white/10 transition-colors duration-200">
                        ...
                        <div class="absolute right-0 w-56 py-2 mt-2 bg-white border rounded-xl shadow-xl dropdown-menu top-full border-slate-200">
                            <NuxtLink to="/profile" class="flex items-center gap-3 px-4 py-2.5 text-sm cursor-pointer text-primary hover:bg-slate-50 hover:text-third transition-colors">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                                </svg>
                                บัญชีของฉัน
                            </NuxtLink>
                            <NuxtLink v-if="!isDriverVerified" to="/profile/driver-verification" class="flex items-center gap-3 px-4 py-2.5 text-sm cursor-pointer text-primary hover:bg-slate-50 hover:text-third transition-colors">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                </svg>
                                ยืนยันใบขับขี่
                            </NuxtLink>
                            <NuxtLink to="/profile/my-vehicle" class="flex items-center gap-3 px-4 py-2.5 text-sm cursor-pointer text-primary hover:bg-slate-50 hover:text-third transition-colors">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                            ...
                            <button @click="logout" class="flex items-center gap-3 w-full px-4 py-2.5 text-sm text-left text-red-600 cursor-pointer hover:bg-red-50 transition-colors">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                    ...
                    <div v-else-if="token && user && user.role === 'ADMIN'" class="relative ml-1 dropdown-trigger">
                        ...
                        <div class="absolute right-0 w-44 py-1 mt-1 bg-white border rounded-lg shadow-lg dropdown-menu top-full border-slate-200">
                            <NuxtLink to="/profile" class="block px-4 py-2 text-sm cursor-pointer text-primary hover:bg-slate-50 hover:text-third">
                                บัญชีของฉัน
                            </NuxtLink>
                            <NuxtLink to="/admin/users" class="block px-4 py-2 text-sm cursor-pointer text-primary hover:bg-slate-50 hover:text-third">
                                Dashboard
                            </NuxtLink>
                            <hr class="my-1 border-slate-100" />
                            <button @click="logout" class="block w-full px-4 py-2 text-sm text-left text-red-600 cursor-pointer hover:bg-red-50">
                                ออกจากระบบ
                            </button>
                        </div>
                    </div>
