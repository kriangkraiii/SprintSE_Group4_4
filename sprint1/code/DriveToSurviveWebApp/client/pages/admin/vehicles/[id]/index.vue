            ...
            <div class="mx-auto max-w-8xl">
                <div class="flex flex-col gap-3 mb-6 sm:flex-row sm:items-center sm:justify-between">
                    <div class="flex items-center gap-3">
                        <h1 class="text-2xl font-semibold text-primary">รายละเอียดข้อมูลยานพาหนะ</h1>
                        <span class="text-sm text-slate-400">ดูข้อมูลทั้งหมดของยานพาหนะ</span>
                    </div>
                        ...
                        <div class="w-full max-w-[80rem] mx-auto space-y-8">
                            ...
                            <section>
                                ...
                                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                                    ...
                                    <div>
                                        <label class="block mb-1 text-xs font-medium text-slate-500">รุ่น /
                                            ยี่ห้อ</label>
                                        <div
                                    ...
                                    <div>
                                        <label
                                            class="block mb-1 text-xs font-medium text-slate-500">ประเภทยานพาหนะ</label>
                                        <div
                                            class="w-full px-3 py-2.5 border border-slate-200 rounded-md bg-slate-50 text-primary">
                                    ...
                                    <div>
                                        <label
                                            class="block mb-1 text-xs font-medium text-slate-500">เป็นค่าเริ่มต้น</label>
                                        <div
                                            class="w-full px-3 py-2.5 border border-slate-200 rounded-md bg-slate-50 text-primary">
                                            <span
                                                :class="vehicle?.isDefault ? 'text-green-700 font-semibold' : 'text-slate-500'">
                            ...
                            <!-- ข้อมูลเจ้าของ -->
                            <section>
                                <h3 class="mb-3 text-sm font-semibold text-primary">ข้อมูลเจ้าของ</h3>
                                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">

                                    <div>
                                        <label class="block mb-1 text-xs font-medium text-slate-500">ชื่อ -
                                            นามสกุล</label>
                                        <div
                                            class="w-full px-3 py-2.5 border border-slate-200 rounded-md bg-slate-50 text-primary">
                            ...
                            <!-- รูปภาพยานพาหนะ -->
                            <section>
                                <h3 class="mb-3 text-sm font-semibold text-primary">รูปภาพยานพาหนะ</h3>
                                ...
                                <div class="grid grid-cols-1 gap-6 sm:grid-cols-3">
                                    ...
                                    <div>
                                        ...
                                        <a v-if="vehicle?.photos?.[0]" :href="vehicle.photos[0]" target="_blank"
                                            class="block p-4 text-center border-2 border-slate-200 border-dashed rounded-md hover:shadow-sm">
                                            <img :src="vehicle.photos[0]" class="object-cover w-full h-40 rounded-md"
                                                alt="front" />
                                        </a>
                                        <div v-else
                                            class="p-10 text-center text-slate-400 border-2 border-slate-200 border-dashed rounded-md bg-slate-50">
                                            ไม่พบรูป
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        <label
                                            class="block mb-1 text-xs font-medium text-slate-500">รูปภายใน</label>
                            ...
                            <!-- ข้อมูลระบบ -->
                            <section>
                                <h3 class="mb-3 text-sm font-semibold text-primary">ข้อมูลระบบ</h3>
                                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                                    <div>
                                    ...
                                    <div>
                                        <label class="block mb-1 text-xs font-medium text-slate-500">อัปเดตล่าสุด</label>
                                        <div
                                            class="w-full px-3 py-2.5 border border-slate-200 rounded-md bg-slate-50 text-primary">
