            ...
            <div class="mx-auto max-w-7xl">
                ...
                <div class="flex flex-col gap-3 mb-6 sm:flex-row sm:items-center sm:justify-between">
                    <div class="flex items-center gap-3">
                        <h1 class="text-2xl font-semibold text-primary">แก้ไขเส้นทาง (แอดมิน)</h1>
                        <span class="text-sm text-slate-400">อัปเดตข้อมูลเส้นทางสำหรับผู้ขับและรถที่เลือก</span>
                    </div>
                </div>
                    ...
                    <main class="flex-1 p-6 sm:p-8">
                        <form @submit.prevent="handleSubmit" class="space-y-10">
                            ...
                            <section class="space-y-4">
                                <h2 class="text-lg font-semibold text-primary">ผู้ขับขี่และรถยนต์</h2>

                                <!-- ผู้ขับ (ล็อกแก้ไข) -->
                                <div class="relative">
                                    <label class="block mb-2 text-sm font-medium text-primary">ค้นหาผู้ขับ (อีเมล /
                                        ชื่อ / Username)</label>
                                ...
                                <!-- รถ -->
                                <div>
                                    <label class="block mb-2 text-sm font-medium text-primary">เลือกรถของผู้ขับ</label>
                            ...
                            <section class="space-y-6">
                                <h2 class="text-lg font-semibold text-primary">ข้อมูลเส้นทาง</h2>

                                <!-- แผนที่พรีวิว -->
                                <div>
                                    <h3 class="mb-2 text-sm font-semibold text-primary">แผนที่เส้นทาง</h3>
                                ...
                                <!-- Waypoints -->
                                <div>
                                    <h3 class="mb-2 text-sm font-semibold text-primary">จุดแวะระหว่างทาง</h3>
                                    <div class="space-y-4">
                                        <div v-for="(w, idx) in form.waypoints" :key="idx"
                                            ...
                                            <div class="flex gap-2 mt-2">
                                                <button type="button" @click="openPicker('waypoint', idx)"
                                                    class="px-3 py-1.5 text-sm border border-slate-200 rounded-md hover:bg-slate-50">
                                                    เลือกจากแผนที่
                                                </button>
                                        ...
                                        <button type="button" @click="addWaypoint"
                                            class="px-4 py-2 text-sm bg-slate-100 border rounded-md hover:bg-slate-200">
                                            + เพิ่มจุดแวะ
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                                    ...
                                    <div>
                                        <label class="block mb-1 text-xs font-medium text-slate-500">ราคา/ที่นั่ง
                                            (บาท)</label>
                                ...
                                <div>
                                    <label
                                        class="block mb-1 text-xs font-medium text-slate-500">เงื่อนไขการเดินทาง</label>
